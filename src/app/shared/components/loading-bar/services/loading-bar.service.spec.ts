...
describe('LoadingBarService', () => {
  ...
  let providers = [LoadingBarService];
  ...
  beforeEach(
    inject([LoadingBarService], (slbs: LoadingBarService) => {
      service = slbs;
    })
  );

  it('is defined', () => {
    expect(LoadingBarService).toBeDefined();
    expect(service instanceof LoadingBarService).toBeTruthy();
  });
