...
describe('LoadingBarComponent', () => {
  let componentFixture: ComponentFixture<LoadingBarComponent>;
  let component: LoadingBarComponent;
  let containerDiv: HTMLDivElement;
  let progressDiv: HTMLDivElement;

  let providers = [LoadingBarComponent];
  ...
  beforeEach(() => {
    componentFixture = TestBed.createComponent<LoadingBarComponent>(
      LoadingBarComponent
    );
